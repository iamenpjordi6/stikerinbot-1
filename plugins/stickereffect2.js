...
const effects = ['calender', 'draw-image', 'sketch-image', 'burning-image']
...
`.trim()
  ...
  let apiUrl = global.API('zeks', '/search/freefire',/', encodeURIComponent(effect), {
    avatar: url
  })
  try {
